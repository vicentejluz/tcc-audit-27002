...
insert into tb_question  values(default,"b) Os acessos às informações e outros ativos são provisionados?",	18	);
...
insert into tb_question  values(default,"a) A organização possui processos de aquisição de aquisição, uso gestão e saída de serviços em nuvem de acordo com requisitos próprios de segurança da informação?",	23	);
...
insert into tb_question  values(default,"e) A empresa aplica algum processo disciplinar em caso de descobrimentos?",	39	);
...
insert into tb_question  values(default,"b) A empresa possui controle de acordo com as leis vigentes quanto tempo aquela informação deve ser mantida como sigilosa?",	43	);
insert into tb_question  values(default,"c) Possui um plano de ação em caso de vazamento destas informações?",	43	);
insert into tb_question  values(default,"d) Empresa faz um monitoramento de quais pessoas estão acessando estas informações ou tentou acessá-las?",	43	);
insert into tb_question  values(default,"e) Política de destruição destes dados?",	43	);
...
insert into tb_question  values(default,"a) A organização possui perímetros de segurança física definidos para proteger as áreas que contêm informações e outros ativos associados?",	46	);
...
insert into tb_question  values(default,"e) Os requisitos de segurança da informação que a organização considera importantes está contemplados por um perímetro de segurança física?",	46	);
...
insert into tb_question  values(default,"b) Os dispositivos móveis usados fora das instalações da organização são protegidos?",	54	);
insert into tb_question  values(default,"c) É necessário manter um registro da cadeia de custódia dos equipamentos quando forem transferidos entre diferentes indivíduos ou partes interessadas?",	54	);
insert into tb_question  values(default,"d) É necessário exigir autorização para a remoção de equipamentos e mídias das instalações da organização e manter um registro dessas remoções?",	54	);
...
insert into tb_question  values(default,"a) Você assegura que os equipamentos que apoiam os serviços de infraestrutura sejam configurados, operados e mantidos de acordo com as especificações do fabricante pertinente?",	56	);
insert into tb_question  values(default,"b) Você assegura que os serviços de infraestrutura sejam avaliados regularmente frente à sua capacidade de atender ao crescimento dos negócios e interações com outros serviços de infraestrutura?",	56	);
insert into tb_question  values(default,"c) Você assegura que os equipamentos que apoiam os serviços de infraestrutura sejam inspecionados e testados regularmente para assegurar seu bom funcionamento?",	56	);
insert into tb_question  values(default,"d) Você assegura que a infraestrutura tenha múltiplas fontes com roteamento físico diversificado?",	56	);
insert into tb_question  values(default,"e) Você assegura que os equipamentos dos serviços de infraestrutura estejam em uma rede separada dos recursos de tratamento de informações, caso conectados a uma rede?",	56	);
...
-- DADOS DE TESTE A PARTIR DESSE PONTO --
insert into tb_company values(default,"Santo André", "09110330","São Paulo","Rua Joge Chammas 26, Vila América", "02421421/0001-11", "Mustache da Massa");


insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	1	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	2	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	3	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	4	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	5	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	6	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	7	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	8	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	9	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	10	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	11	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	12	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	13	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	14	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	15	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	16	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	17	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	18	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	19	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	20	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	21	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	22	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	23	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	24	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	25	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	26	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	27	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	28	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	29	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	30	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	31	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	32	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	33	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	34	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	35	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	36	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	37	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	38	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	39	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	40	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	41	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	42	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	43	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	44	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	45	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	46	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	47	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	48	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	49	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	50	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	51	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	52	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	53	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	54	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	55	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	56	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	57	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	58	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	59	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	60	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	61	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	62	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	63	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	64	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	65	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	66	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	67	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	68	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	69	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	70	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	71	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	72	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	73	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	74	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	75	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	76	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	77	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	78	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	79	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	80	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	81	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	82	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	83	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	84	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	85	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	86	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	87	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	88	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	89	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	90	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	91	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	92	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	93	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	94	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	95	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	96	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	97	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	98	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	99	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	100	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	101	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	102	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	103	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	104	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	105	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	106	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	107	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	108	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	109	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	110	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	111	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	112	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	113	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	114	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	115	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	116	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	117	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	118	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	119	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	120	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	121	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	122	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	123	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	124	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	125	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	126	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	127	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	128	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	129	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	130	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	131	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	132	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	133	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	134	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	135	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	136	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	137	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	138	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	139	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	140	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	141	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	142	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	143	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	144	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	145	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	146	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	147	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	148	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	149	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	150	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	151	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	152	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	153	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	154	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	155	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	156	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	157	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	158	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	159	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	160	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	161	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	162	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	163	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	164	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	165	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	166	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	167	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	168	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	169	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	170	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	171	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	172	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	173	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	174	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	175	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	176	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	177	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	178	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	179	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	180	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	181	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	182	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	183	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	184	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	185	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	186	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	187	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	188	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	189	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	190	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	191	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	192	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	193	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	194	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	195	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	196	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	197	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	198	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	199	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	200	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	201	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	202	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	203	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	204	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	205	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	206	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	207	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	208	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	209	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	210	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	211	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	212	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	213	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	214	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	215	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	216	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	217	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	218	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	219	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	220	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	221	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	222	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	223	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	224	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	225	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	226	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	227	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	228	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	229	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	230	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	231	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	232	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	233	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	234	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	235	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	236	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	237	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	238	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	239	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	240	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	241	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	242	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	243	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	244	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	245	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	246	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	247	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	248	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	249	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	250	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	251	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	252	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	253	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	254	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	255	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	256	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	257	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	258	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	259	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	260	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	261	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	262	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	263	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	264	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	265	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	266	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	267	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	268	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	269	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	270	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	271	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	272	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	273	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	274	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	275	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	276	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	277	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	278	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	279	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	280	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	281	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	282	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	283	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	284	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	285	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	286	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	287	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	288	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	289	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	290	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	291	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	292	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	293	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	294	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	295	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	296	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	297	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	298	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	299	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	300	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	301	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	302	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	303	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	304	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	305	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	306	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	307	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	308	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	309	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	310	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	311	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	312	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	313	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	314	);
insert into tb_answer values (default, 	0, 	1, 	0, 	0, 	1, 	315	);
insert into tb_answer values (default, 	0, 	0, 	1, 	0, 	1, 	316	);
insert into tb_answer values (default, 	0, 	0, 	0, 	1, 	1, 	317	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	318	);
insert into tb_answer values (default, 	1, 	0, 	0, 	0, 	1, 	319	);

insert into tb_weight values (1,	1.0	);
insert into tb_weight values (2,	1.0	);
insert into tb_weight values (3,	1.0	);
insert into tb_weight values (4,	0	);
insert into tb_weight values (5,	0	);
insert into tb_weight values (6,	0.5	);
insert into tb_weight values (7,	1.0	);
insert into tb_weight values (8,	1.0	);
insert into tb_weight values (9,	1.0	);
insert into tb_weight values (10,	0	);
insert into tb_weight values (11,	0	);
insert into tb_weight values (12,	0.5	);
insert into tb_weight values (13,	1.0	);
insert into tb_weight values (14,	1.0	);
insert into tb_weight values (15,	1.0	);
insert into tb_weight values (16,	0	);
insert into tb_weight values (17,	0	);
insert into tb_weight values (18,	0.5	);
insert into tb_weight values (19,	1	);
insert into tb_weight values (20,	1	);
insert into tb_weight values (21,	1	);
insert into tb_weight values (22,	0	);
insert into tb_weight values (23,	0	);
insert into tb_weight values (24,	0.5	);
insert into tb_weight values (25,	1	);
insert into tb_weight values (26,	1	);
insert into tb_weight values (27,	1	);
insert into tb_weight values (28,	0	);
insert into tb_weight values (29,	0	);
insert into tb_weight values (30,	0.5	);
insert into tb_weight values (31,	1	);
insert into tb_weight values (32,	1	);
insert into tb_weight values (33,	1	);
insert into tb_weight values (34,	0	);
insert into tb_weight values (35,	0	);
insert into tb_weight values (36,	0.5	);
insert into tb_weight values (37,	1	);
insert into tb_weight values (38,	1	);
insert into tb_weight values (39,	1	);
insert into tb_weight values (40,	0	);
insert into tb_weight values (41,	0	);
insert into tb_weight values (42,	0.5	);
insert into tb_weight values (43,	1	);
insert into tb_weight values (44,	1	);
insert into tb_weight values (45,	1	);
insert into tb_weight values (46,	0	);
insert into tb_weight values (47,	0	);
insert into tb_weight values (48,	0.5	);
insert into tb_weight values (49,	1	);
insert into tb_weight values (50,	1	);
insert into tb_weight values (51,	1	);
insert into tb_weight values (52,	0	);
insert into tb_weight values (53,	0	);
insert into tb_weight values (54,	0.5	);
insert into tb_weight values (55,	1	);
insert into tb_weight values (56,	1	);
insert into tb_weight values (57,	1	);
insert into tb_weight values (58,	0	);
insert into tb_weight values (59,	0	);
insert into tb_weight values (60,	0.5	);
insert into tb_weight values (61,	1	);
insert into tb_weight values (62,	1	);
insert into tb_weight values (63,	1	);
insert into tb_weight values (64,	0	);
insert into tb_weight values (65,	0	);
insert into tb_weight values (66,	0.5	);
insert into tb_weight values (67,	1	);
insert into tb_weight values (68,	1	);
insert into tb_weight values (69,	1	);
insert into tb_weight values (70,	0	);
insert into tb_weight values (71,	0	);
insert into tb_weight values (72,	0.5	);
insert into tb_weight values (73,	1	);
insert into tb_weight values (74,	1	);
insert into tb_weight values (75,	1	);
insert into tb_weight values (76,	0	);
insert into tb_weight values (77,	0	);
insert into tb_weight values (78,	0.5	);
insert into tb_weight values (79,	1	);
insert into tb_weight values (80,	1	);
insert into tb_weight values (81,	1	);
insert into tb_weight values (82,	0	);
insert into tb_weight values (83,	0	);
insert into tb_weight values (84,	0.5	);
insert into tb_weight values (85,	1	);
insert into tb_weight values (86,	1	);
insert into tb_weight values (87,	1	);
insert into tb_weight values (88,	0	);
insert into tb_weight values (89,	0	);
insert into tb_weight values (90,	0.5	);
insert into tb_weight values (91,	1	);
insert into tb_weight values (92,	1	);
insert into tb_weight values (93,	1	);
insert into tb_weight values (94,	0	);
insert into tb_weight values (95,	0	);
insert into tb_weight values (96,	0.5	);
insert into tb_weight values (97,	1	);
insert into tb_weight values (98,	1	);
insert into tb_weight values (99,	1	);
insert into tb_weight values (100,	0	);
insert into tb_weight values (101,	0	);
insert into tb_weight values (102,	0.5	);
insert into tb_weight values (103,	1	);
insert into tb_weight values (104,	1	);
insert into tb_weight values (105,	1	);
insert into tb_weight values (106,	0	);
insert into tb_weight values (107,	0	);
insert into tb_weight values (108,	0.5	);
insert into tb_weight values (109,	1	);
insert into tb_weight values (110,	1	);
insert into tb_weight values (111,	1	);
insert into tb_weight values (112,	0	);
insert into tb_weight values (113,	0	);
insert into tb_weight values (114,	0.5	);
insert into tb_weight values (115,	1	);
insert into tb_weight values (116,	1	);
insert into tb_weight values (117,	1	);
insert into tb_weight values (118,	0	);
insert into tb_weight values (119,	0	);
insert into tb_weight values (120,	0.5	);
insert into tb_weight values (121,	1	);
insert into tb_weight values (122,	1	);
insert into tb_weight values (123,	1	);
insert into tb_weight values (124,	0	);
insert into tb_weight values (125,	0	);
insert into tb_weight values (126,	0.5	);
insert into tb_weight values (127,	1	);
insert into tb_weight values (128,	1	);
insert into tb_weight values (129,	1	);
insert into tb_weight values (130,	0	);
insert into tb_weight values (131,	0	);
insert into tb_weight values (132,	0.5	);
insert into tb_weight values (133,	1	);
insert into tb_weight values (134,	1	);
insert into tb_weight values (135,	1	);
insert into tb_weight values (136,	0	);
insert into tb_weight values (137,	0	);
insert into tb_weight values (138,	0.5	);
insert into tb_weight values (139,	1	);
insert into tb_weight values (140,	1	);
insert into tb_weight values (141,	1	);
insert into tb_weight values (142,	0	);
insert into tb_weight values (143,	0	);
insert into tb_weight values (144,	0.5	);
insert into tb_weight values (145,	1	);
insert into tb_weight values (146,	1	);
insert into tb_weight values (147,	1	);
insert into tb_weight values (148,	0	);
insert into tb_weight values (149,	0	);
insert into tb_weight values (150,	0.5	);
insert into tb_weight values (151,	1	);
insert into tb_weight values (152,	1	);
insert into tb_weight values (153,	1	);
insert into tb_weight values (154,	0	);
insert into tb_weight values (155,	0	);
insert into tb_weight values (156,	0.5	);
insert into tb_weight values (157,	1	);
insert into tb_weight values (158,	1	);
insert into tb_weight values (159,	1	);
insert into tb_weight values (160,	0	);
insert into tb_weight values (161,	0	);
insert into tb_weight values (162,	0.5	);
insert into tb_weight values (163,	1	);
insert into tb_weight values (164,	1	);
insert into tb_weight values (165,	1	);
insert into tb_weight values (166,	0	);
insert into tb_weight values (167,	0	);
insert into tb_weight values (168,	0.5	);
insert into tb_weight values (169,	1	);
insert into tb_weight values (170,	1	);
insert into tb_weight values (171,	1	);
insert into tb_weight values (172,	0	);
insert into tb_weight values (173,	0	);
insert into tb_weight values (174,	0.5	);
insert into tb_weight values (175,	1	);
insert into tb_weight values (176,	1	);
insert into tb_weight values (177,	1	);
insert into tb_weight values (178,	0	);
insert into tb_weight values (179,	0	);
insert into tb_weight values (180,	0.5	);
insert into tb_weight values (181,	1	);
insert into tb_weight values (182,	1	);
insert into tb_weight values (183,	1	);
insert into tb_weight values (184,	0	);
insert into tb_weight values (185,	0	);
insert into tb_weight values (186,	0.5	);
insert into tb_weight values (187,	1	);
insert into tb_weight values (188,	1	);
insert into tb_weight values (189,	1	);
insert into tb_weight values (190,	0	);
insert into tb_weight values (191,	0	);
insert into tb_weight values (192,	0.5	);
insert into tb_weight values (193,	1	);
insert into tb_weight values (194,	1	);
insert into tb_weight values (195,	1	);
insert into tb_weight values (196,	0	);
insert into tb_weight values (197,	0	);
insert into tb_weight values (198,	0.5	);
insert into tb_weight values (199,	1	);
insert into tb_weight values (200,	1	);
insert into tb_weight values (201,	1	);
insert into tb_weight values (202,	0	);
insert into tb_weight values (203,	0	);
insert into tb_weight values (204,	0.5	);
insert into tb_weight values (205,	1	);
insert into tb_weight values (206,	1	);
insert into tb_weight values (207,	1	);
insert into tb_weight values (208,	0	);
insert into tb_weight values (209,	0	);
insert into tb_weight values (210,	0.5	);
insert into tb_weight values (211,	1	);
insert into tb_weight values (212,	1	);
insert into tb_weight values (213,	1	);
insert into tb_weight values (214,	0	);
insert into tb_weight values (215,	0	);
insert into tb_weight values (216,	0.5	);
insert into tb_weight values (217,	1	);
insert into tb_weight values (218,	1	);
insert into tb_weight values (219,	1	);
insert into tb_weight values (220,	0	);
insert into tb_weight values (221,	0	);
insert into tb_weight values (222,	0.5	);
insert into tb_weight values (223,	1	);
insert into tb_weight values (224,	1	);
insert into tb_weight values (225,	1	);
insert into tb_weight values (226,	0	);
insert into tb_weight values (227,	0	);
insert into tb_weight values (228,	0.5	);
insert into tb_weight values (229,	1	);
insert into tb_weight values (230,	1	);
insert into tb_weight values (231,	1	);
insert into tb_weight values (232,	0	);
insert into tb_weight values (233,	0	);
insert into tb_weight values (234,	0.5	);
insert into tb_weight values (235,	1	);
insert into tb_weight values (236,	1	);
insert into tb_weight values (237,	1	);
insert into tb_weight values (238,	0	);
insert into tb_weight values (239,	0	);
insert into tb_weight values (240,	0.5	);
insert into tb_weight values (241,	1	);
insert into tb_weight values (242,	1	);
insert into tb_weight values (243,	1	);
insert into tb_weight values (244,	0	);
insert into tb_weight values (245,	0	);
insert into tb_weight values (246,	0.5	);
insert into tb_weight values (247,	1	);
insert into tb_weight values (248,	1	);
insert into tb_weight values (249,	1	);
insert into tb_weight values (250,	0	);
insert into tb_weight values (251,	0	);
insert into tb_weight values (252,	0.5	);
insert into tb_weight values (253,	1	);
insert into tb_weight values (254,	1	);
insert into tb_weight values (255,	1	);
insert into tb_weight values (256,	0	);
insert into tb_weight values (257,	0	);
insert into tb_weight values (258,	0.5	);
insert into tb_weight values (259,	1	);
insert into tb_weight values (260,	1	);
insert into tb_weight values (261,	1	);
insert into tb_weight values (262,	0	);
insert into tb_weight values (263,	0	);
insert into tb_weight values (264,	0.5	);
insert into tb_weight values (265,	1	);
insert into tb_weight values (266,	1	);
insert into tb_weight values (267,	1	);
insert into tb_weight values (268,	0	);
insert into tb_weight values (269,	0	);
insert into tb_weight values (270,	0.5	);
insert into tb_weight values (271,	1	);
insert into tb_weight values (272,	1	);
insert into tb_weight values (273,	1	);
insert into tb_weight values (274,	0	);
insert into tb_weight values (275,	0	);
insert into tb_weight values (276,	0.5	);
insert into tb_weight values (277,	1	);
insert into tb_weight values (278,	1	);
insert into tb_weight values (279,	1	);
insert into tb_weight values (280,	0	);
insert into tb_weight values (281,	0	);
insert into tb_weight values (282,	0.5	);
insert into tb_weight values (283,	1	);
insert into tb_weight values (284,	1	);
insert into tb_weight values (285,	1	);
insert into tb_weight values (286,	0	);
insert into tb_weight values (287,	0	);
insert into tb_weight values (288,	0.5	);
insert into tb_weight values (289,	1	);
insert into tb_weight values (290,	1	);
insert into tb_weight values (291,	1	);
insert into tb_weight values (292,	0	);
insert into tb_weight values (293,	0	);
insert into tb_weight values (294,	0.5	);
insert into tb_weight values (295,	1	);
insert into tb_weight values (296,	1	);
insert into tb_weight values (297,	1	);
insert into tb_weight values (298,	1	);
insert into tb_weight values (299,	1	);
insert into tb_weight values (300,	1	);
insert into tb_weight values (301,	0	);
insert into tb_weight values (302,	0	);
insert into tb_weight values (303,	0.5	);
insert into tb_weight values (304,	1	);
insert into tb_weight values (305,	1	);
insert into tb_weight values (306,	1	);
insert into tb_weight values (307,	0	);
insert into tb_weight values (308,	0	);
insert into tb_weight values (309,	0.5	);
insert into tb_weight values (310,	1	);
insert into tb_weight values (311,	1	);
insert into tb_weight values (312,	1	);
insert into tb_weight values (313,	0	);
insert into tb_weight values (314,	0	);
insert into tb_weight values (315,	0.5	);
insert into tb_weight values (316,	1	);
insert into tb_weight values (317,	1	);
insert into tb_weight values (318,	1	);
insert into tb_weight values (319,	1	);


/* Cadastra  uma empresa no front e depois roda esse update para ter acesso a empresa 1 que tem os dados já populados */
UPDATE tb_employee SET id_company = 1 WHERE id_employee = 1;
/* Depois deleta a empresa que cadastrou no front, pq como mudou para a empresa 1 ele vai ficar inutilizável */
DELETE FROM tb_company WHERE id_company = 2;
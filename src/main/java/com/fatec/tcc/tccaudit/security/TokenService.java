...
public class TokenService {
    ...
    public String generateToken(Employee employee) {
        try {
            ...
            return JWT.create().withIssuer("Stock_Management").withSubject(employee.getEmail())
    ...
    public String getSubject(String tokenJWT) {
        try {
            Algorithm algorithm = Algorithm.HMAC256(secret);
            return JWT.require(algorithm).withIssuer("Stock_Management").build().verify(tokenJWT).getSubject();

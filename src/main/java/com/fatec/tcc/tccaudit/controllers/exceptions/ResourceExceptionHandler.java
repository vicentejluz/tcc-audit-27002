...
import com.fatec.tcc.tccaudit.security.exceptions.AuthException;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> authException(DatabaseException e, HttpServletRequest request) {
